        ...
        if not api_key:
            ...
            if user_query:
                try:
                    ...
                    # UNIVERSAL FIX: Use the stable model string
                    model = genai.GenerativeModel('gemini-1.5-flash')
                    
                    # PRO MBA CONTEXT: Explicitly inject unique services list
                    ...
                    prompt = (
                        ...
                        "including Insurance, even if its transaction share is low."
                    )
