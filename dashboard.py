...
CONFIG = {
    ...
    "display_cols": ["Transaction_ID", None, "Service", "Service Type", "Payment_Status"],  
...
if uploaded_file:
    ...
    with col1:
        ...
        display_cols = [c if c != None else amount_col for c in display_cols]
        available_cols = [col for col in display_cols if col in df.columns]
        st.dataframe(df[available_cols].head(15), use_container_width=True)
